...
st.set_page_config(page_title="yolov8n Video Detection", page_icon="🎥", layout="centered")
...
st.title("Video Object Detection with YOLOv8n")
st.markdown("Upload a video and let the YOLOv8n model detect objects in it.")
...
if uploaded_file is not None:
    ...
    # Load the YOLO model
    model = YOLO(r"E:\WARS Project1\Yolov8n\Yolov8n\best .pt")
