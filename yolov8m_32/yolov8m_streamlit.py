...
st.set_page_config(page_title="yolov8m Video Detection", page_icon="🎥", layout="centered")
...
st.title("Video Object Detection with YOLOv8m")
st.markdown("Upload a video and let the YOLOv8m model detect objects in it.")
...
if uploaded_file is not None:
    ...
    # Load the YOLO model
    model = YOLO(r"E:\WARS Project1\yolov8m_32\best.pt")
