...
Original file is located at
    https://colab.research.google.com/drive/1wVzWyioGIVeqS58f0VRzOatvi4tKo5NT
"""
...
model = YOLO('yolov8m.pt')  # 'yolov8n.pt' is the nano model; you can choose 's', 'm', 'l', 'x' for different sizes
...
test_image_path = '/content/drive/MyDrive/Folder/extracted/combine/test/images'
