...
st.set_page_config(page_title="yolov8l Video Detection", page_icon="🎥", layout="centered")
...
st.title("Video Object Detection with YOLOv8l")
st.markdown("Upload a video and let the YOLOv8l model detect objects in it.")
...
if uploaded_file is not None:
    ...
    # Load the YOLO model
    model = YOLO(r"E:\WARS Project1\Yolov8l\Yolov8l\best (1).pt")
